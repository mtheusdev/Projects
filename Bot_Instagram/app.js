...
async function start() {
    ...
    async function getComments(page, selector) {
        const comments = await page.$$eval(selector, links => links.map(link => link.innerText)) // dois cifroes para pegar todos
        return comments
    }
    ...
    await page.goto('https://www.instagram.com/p/CDUbnb_AG6t/')
